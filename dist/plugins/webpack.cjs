...
__export(webpack_exports, {
  YumyumPickrWebpackPlugin: () => YumyumPickrWebpackPlugin,
...
// src/plugins/webpack.ts
var YumyumPickrWebpackPlugin = class {
  port;
  started = false;
  constructor(options = {}) {
        ...
        (assets) => {
          for (const [filename, asset] of Object.entries(assets)) {
            ...
            if (!html.includes("/pickr.js")) {
              ...
              const Sources = compilation.compiler?.webpack?.sources ?? compiler.webpack?.sources;
              if (Sources) {
...
var webpack_default = YumyumPickrWebpackPlugin;
// Annotate the CommonJS export names for ESM import in node:
0 && (module.exports = {
  YumyumPickrWebpackPlugin
});
